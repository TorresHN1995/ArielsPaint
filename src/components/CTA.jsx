    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection variant="zoomIn" className="text-center py-20 sm:py-24">
          ...
          <p className="text-lg sm:text-xl text-white/75 mb-8 max-w-lg mx-auto">
            Get a free, no-obligation estimate today. Let's bring your vision to life.
          </p>
          <a href="#contact" className="btn-glow text-base sm:text-lg rounded-full px-8 sm:px-10 py-4 inline-flex items-center gap-2 shadow-2xl">
            <FaPaperPlane /> Get Your Free Estimate
          </a>
        </AnimatedSection>
      </div>
    </section>
